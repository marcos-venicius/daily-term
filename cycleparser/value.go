...
func (e *InvalidValueError) Error() string {
	return fmt.Sprintf("cycleparser.Value: invalid value %T(%#v) for kind %#v", e.Value, e.Value, e.Kind)
}
...
func (e *InvalidValueKindError) Error() string {
	return "cycleparser.Value: invalid value kind \"" + e.Kind + "\""
}
