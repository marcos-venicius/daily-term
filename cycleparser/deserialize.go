...
func (e *UnmapperError) Error() string {
	return "cycleparser.FromValue: " + e.text
}
...
func (e *InvalidUnmapperKindError) Error() string {
	if e.Expected == "" {
		return "cycleparser.FromValue: unsupported kind (" + e.Kind + ")"
	}
	return "cycleparser.FromValue: unexpected kind (expected: " + e.Expected + ", got: " + e.Kind + ")"
}
...
func (vu *valueUnmapper) fromValue(data *Value, v reflect.Value) error {
	...
	case Int, Int8, Int16, Int32, Int64, TaskState:
